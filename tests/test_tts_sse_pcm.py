#!/usr/bin/env python3
"""Test PCM TTS streaming with SSE events."""
...
def test_tts_streaming():
    """Test PCM TTS streaming with SSE format and verify continuous streaming."""
    ...
    output_file = os.path.join(output_dir, "test_tts_streaming_pcm.pcm")
    ...
    try:
        ...
        logger.info(f"Audio saved to: {output_file} (PCM format: 24kHz, 16-bit signed, little-endian, mono)")
